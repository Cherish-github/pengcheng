            ...
            $("#dateconfirm").unbind('click').click(function() {
                ...
                if (datetime) {
                    if (Math.round(indexS) === 1) { //下午
                        ...
                        var hour_number = parseInt($("#Hourwrapper ul li:eq(" + indexH + ")").html().substr(0, $("#Hourwrapper ul li:eq(" + indexH + ")").html().length - 1));
                        if (hour_number < 10){
                            hour_number = '0' + hour_number;
                        }
                        $("#Hourwrapper ul li:eq(" + indexH + ")").html(hour_number);
                    }
                    var datestr2 ;
                    datestr2  = " " + $("#Hourwrapper ul li:eq(" + indexH + ")").html().substr(0, $("#Minutewrapper ul li:eq(" + indexH + ")").html().length - 1) + ":" +
                ...
                if (Ycallback === undefined) {
                    if (docType) {
                        that.val(datestr);
                        $('#endTime2').val(datestr2);
                    } else {
                        that.html(datestr);
                        $('#endTime2').html(datestr2);
                    }
                } else {
                    Ycallback(datestr);
                }
